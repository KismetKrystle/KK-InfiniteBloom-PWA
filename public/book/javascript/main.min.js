...
height:"0"});this.bottomBar.append(this.buttonBar);this.bottomBar.append(this.bottomLeftBar).append(this.bottomRightBar);this.bottomLeftBar.append(this.edtPageNumber);this.parent.append(this.bottomBar);this.initPageNumber()},initPageNumber:function(){var a=this.edtPageNumber.find("input"),b=parseInt(bookConfig.totalPageCount),c=16;""==bookConfig.pageNumberCaption&&(1E4<=b&&(c=16),1E4>b&&(c=10),1E3>b&&(c=7),100>b&&(c=4),10>b&&(c=3));a.attr("size",c);Color(this.color.add(120));a.css({color:bookConfig.iconColor,
background:"transparent",border:"none"});this.edtPageWidth=this.edtPageNumber.width()},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);global.moreBar=this.extendedBar},resetToolbarColor:function(){this.color=Color(bookConfig.toolbarColor);this.topBarAlpha=Math.min(bookConfig.topToolBarAlpha,bookConfig.ToolBarAlpha);this.extendedBar&&this.extendedBar.$bar.css({"background-color":this.color.rgba(this.topBarAlpha)});this.resetButtonTitleColor();global.PcTelephoneNumberFrame&&
global.PcTelephoneNumberFrame.setColor({color:bookConfig.toolbarColor,textColor:bookConfig.iconFontColor})},setButtonTitle:function(a){if("WeChatShareButton"==a.getClassName())global.WeChatShareImg=new WeChatShare({parent:this.parent,color:"#fff",textColor:bookConfig.toolbarColor,margin:10,padding:10,arrowHeight:12,arrowWidth:12});else if("TelephoneNumberButton"==a.getClassName())global.PcTelephoneNumberFrame=new PcTelephoneNumberBubble({parent:this.parent,color:this.color,textColor:a.fontColor,margin:4,
padding:15,arrowHeight:8,arrowWidth:8});else{var b=new TextBubble({parent:this.parent,text:a.caption,direction:TextBubble.TOP,color:this.color,textColor:a.fontColor,margin:7});a.setTitle(b)}},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),bookConfig.ToolBarVisible?(this.topRightBar.append(this.topRightButton),this.onResize()):this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&
(this.topRightButton.remove(),this.topRightButton=null)},onResize:function(a,b){if(bookConfig.ToolBarVisible){a=void 0==a?this.parent.width():parseInt(a);void 0==b?this.parent.height():parseInt(b);a=a-a/4-a/4;b=this.edtPageWidth+150+20;a<b&&(a=b);b=this.logoBar.find("img").height()+10;var c,d=null==(c=BookInfo)?void 0:c.top();d&&d<b&&(bookConfig.topMargin=b,BookInfo.getBook().adjustBookPosition());this.buttonBarWidth=a;this.resetButtonPosition()}},afterButtonClick:function(a){this.extendedBar.visible&&
"btnSocialShare"!=a.language.key&&(a!=this.btnMore?isPhone()||isPad()||this.extendedBar.hide():(a=this.buttonsInExtendedBar(),a.each(function(b){b.changeColor()}),a=null))},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,buttonWidth:30,buttonTop:5,color:this.color,bottomBar:{leftBar:this.bottomLeftBar,rightBar:this.bottomRightBar},container:{body:this.buttonBar,topRightBar:this.topRightBar,width:this.buttonBarWidth},extended:this.extendedBar.$bar,edtNumber:{body:this.edtPageNumber,
width:this.edtPageWidth,top:8,space:5}})).sort();this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();this.buttons.each(function(a){a.changeColor()}.bind(this))}}).extend("Toolbar");
