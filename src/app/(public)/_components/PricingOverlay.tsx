...
const products = [
  ...
  },
  {
    ...
    features: ["45 poems", "143 insights", "Full-color print", "Free shipping (US)"],
    highlight: false,
  },
  {
    id: "bundle",
    name: "Physical Book - Black and White",
    price: "$22.00",
    description: "Printed paperback in classic black and white, delivered to your door.",
    features: ["45 poems", "143 insights", "Black & white print", "Free shipping (US)"],
    highlight: true,
  },
]
